export default {
  main: {
    ...
    interview_completed_redirect:
      "Será redirecionado dentro de alguns segundos... {count}",
  ...
  login: {
    ...
    email_otp: "Ou envie o token temporário para o seu endereço de e-mail.",
    send_email_token: "Enviar token",
  ...
  validations: {
    ...
    more_errors: "- | e mais um erro | e {count} mais erros",
  },
  ...
  interview_filling_date: "Data de preenchimento",
  interview_filling_date_hint:
    "Data de preenchimento do questionário (por exemplo, manualmente), se for diferente do preenchimento eletrónico.",
};
